...
if __name__ == '__main__':
    ...
    if train_sampler is None:
        train_loader = torch.utils.data.DataLoader(
            trainset, shuffle=True, batch_size=batch_size, num_workers=4, collate_fn=collate_fn, pin_memory=True)
    else:
        train_loader = torch.utils.data.DataLoader(
            trainset, sampler=train_sampler, batch_size=batch_size, num_workers=4, collate_fn=collate_fn, pin_memory=True)
    
    test_loader = torch.utils.data.DataLoader(
        testset, batch_size=batch_size, num_workers=4, collate_fn=collate_fn, pin_memory=True)
