...
public:
	...
	virtual void printParameter(){
        ...
        sprintf(logStr, "weight:%f, %f, %f, %f, %f, %f, %f, %f, %f, %f;\n", w->get(0,0,0), w->get(0,1,0), w->get(0, 2, 0), w->get(0,3,0), w->get(0,4,0), w->get(0, 5, 0),w->get(0,6,0), w->get(0,7,0), w->get(0, 8, 0), w->get(0, 9, 0));
		LOG(logStr, "Result/log.txt");
        sprintf(logStr, "weight:%f, %f, %f, %f, %f, %f, %f, %f, %f, %f;\n", w->get(0,10,0), w->get(0,11,0), w->get(0, 12, 0), w->get(0,13,0), w->get(0,14,0), w->get(0, 15, 0), w->get(0,16,0), w->get(0,17,0), w->get(0, 18, 0), w->get(0, 19, 0));
		LOG(logStr, "Result/log.txt");
        sprintf(logStr, "weight:%f, %f, %f, %f, %f, %f, %f, %f, %f, %f;\n", w->get(0,20,0), w->get(0,21,0), w->get(0, 22, 0), w->get(0,23,0), w->get(0,24,0), w->get(0, 25, 0), w->get(0,26,0), w->get(0,27,0), w->get(0, 28, 0), w->get(0, 29, 0));
		LOG(logStr, "Result/log.txt");
    ...
    virtual void printFireCount(){
		...
		LOG(logStr, "Result/log.txt");
        sprintf(logStr, "fire count: %d, %d, %d, %d, %d, %d, %d, %d, %d, %d;\n", fireCount->get(0,10,0), fireCount->get(0,11,0), fireCount->get(0,12,0), fireCount->get(0,13,0), fireCount->get(0,14,0), fireCount->get(0,15,0), fireCount->get(0,16,0), fireCount->get(0,17,0), fireCount->get(0,18,0), fireCount->get(0,19,0));
		LOG(logStr, "Result/log.txt");
        sprintf(logStr, "fire count: %d, %d, %d, %d, %d, %d, %d, %d, %d, %d;\n", fireCount->get(0,20,0), fireCount->get(0,21,0), fireCount->get(0,22,0), fireCount->get(0,23,0), fireCount->get(0,24,0), fireCount->get(0,25,0), fireCount->get(0,26,0), fireCount->get(0,27,0), fireCount->get(0,28,0), fireCount->get(0,29,0));
		LOG(logStr, "Result/log.txt");
    }
