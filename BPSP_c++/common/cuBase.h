...
// (int* output_time,int* input_time,int o_idx,int i_idx,int endTime);
__device__ float single_stdp(int* output_time,int* input_time,int n_ospikes,int n_ispikes,int o_idx,int i_idx,int endTime,int T_REFRAC,float TAU_M,float TAU_S);
